...
from core.security.security import create_access_token, verify_password, ACCESS_TOKEN_EXPIRE_MINUTES
...
oauth2_scheme = OAuth2PasswordBearer(tokenUrl="/token") # Matches the login endpoint path
