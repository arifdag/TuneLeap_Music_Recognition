...
class RecognitionService {
              ...
              if (firstMatch != null) {
                ...
                if (songId != null) {
                  ...
                  if (isLoggedIn) {
                    ...
                    // Update playlists with the new song
                    _updatePlaylistsWithNewSong(context);
                  } else {
  ...
  // Update playlists when a new song is recognized
  void _updatePlaylistsWithNewSong(BuildContext? context) {
    if (context != null) {
      try {
        final playlistProvider = Provider.of<PlaylistProvider>(context, listen: false);
        playlistProvider.onNewSongRecognized();
      } catch (e) {
        print('Error updating playlists: $e');
      }
    }
  }
} 